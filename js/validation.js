// Лучше выносить все обработчики событий в отдельные функции. Так мы избегаем вложености, которая ухудшает читаемость
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('registrationForm').addEventListener('submit', function(event) {
      ...
      /* Такую проверку с регуляркой лучше вынести в отдельную функцию */
    ...
    // agree тут недоступна, так как она объявлена внутри обработчика события registrationForm
